...
class Token {
  ...
  constructor ({
    ...
    this.decimals = decimals ? BigNumber.from(decimals) : undefined
    this.owner = owner
  ...
  stringify() {
    return util.stringifyBalance(this.balance, this.decimals || BigNumber.from(0), this.balanceDecimals)
  }
